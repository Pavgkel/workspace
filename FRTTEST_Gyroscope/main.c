...
void Gyro(void *pvParameters)
{
	...
	if ((xPosition > -105) && (xPosition < -75))
		GPIO_SetBits(GPIOE, GPIO_Pin_8);
	if ((xPosition > -75) && (xPosition < -45))
		GPIO_SetBits(GPIOE, GPIO_Pin_9);
	if ((xPosition > -45) && (xPosition < -15))
		GPIO_SetBits(GPIOE, GPIO_Pin_10);
	if ((xPosition > -15) && (xPosition < 15))
		GPIO_SetBits(GPIOE, GPIO_Pin_11);
	if ((xPosition > 15) && (xPosition < 45))
		GPIO_SetBits(GPIOE, GPIO_Pin_12);
	if ((xPosition > 45) && (xPosition < 75))
		GPIO_SetBits(GPIOE, GPIO_Pin_13);
	if ((xPosition>75) && (xPosition<105))
...
int main(void)
{
	...
	writeData(0x20, 0x0A);
	writeData(0x23, 0x30);
	xTaskCreate(Gyro, (signed char *) "Grow", configMINIMAL_STACK_SIZE, NULL,
			2, (xTaskHandle *) NULL);
	vTaskStartScheduler();
